...
Next, you'll learn how to upgrade this to use **structured outputs** with Zod schemas for guaranteed valid JSON responses every time.

**Coming up:**
- Upgrading to Structured Outputs (more reliable, type-safe)
