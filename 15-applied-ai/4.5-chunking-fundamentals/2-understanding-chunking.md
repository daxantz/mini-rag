...
1. **Research 2 alternative chunking strategies** (beyond sentence-based chunking)
   - Examples: Semantic chunking, sliding window, paragraph-based, token-based, recursive chunking
   - Find at least 2 different strategies

2. **For each strategy, explain:**
   - How it works (briefly)
   - When to use it (specific use cases)
   - Pros and cons vs sentence-based chunking
   - Real-world example where it's better

3. **Include:**
   - Code snippet or pseudocode showing the approach
   - Example input/output for each strategy
   - Comparison table of all 3 strategies (sentence-based + your 2)

**Example Structure:**

| Strategy | Best For | Pros | Cons |
|----------|----------|------|------|
| Sentence-based | General docs | Maintains meaning | May break code blocks |
| Semantic | Long-form content | Keeps related ideas together | More complex |
...
**Why This Matters:** Different content types need different chunking strategies. Understanding trade-offs helps you build better RAG systems.
